...
public class CustomerDetailsDTO {
    ...
    public LoansDTO getLoanDto() {
        return loanDto;
    }

    public void setLoanDto(LoansDTO loanDto) {
        this.loanDto = loanDto;
    }

    public CardsDTO getCardDto() {
        return cardDto;
    }

    public void setCardDto(CardsDTO cardDto) {
